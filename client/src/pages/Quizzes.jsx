...
export default function Quizzes() {
 return <section className="page-shell"><div className="container py-5">
  ...
  <h1 className="display-6 fw-bold">Quizzes</h1>
  <p className="text-muted">Practice, compete and improve.</p>
  <div className="row g-4 mt-2">
   <div className="col-lg-8"><div className="card border-0 shadow-sm p-4">
    <h3>Quizzes workspace</h3><p>Collaborative learning tools, resources, activity and progress data appear here.</p>
