...
export default function Dashboard() {
 return <section className="page-shell"><div className="container py-5">
  ...
  <p className="text-muted">Personalized learning metrics and shortcuts.</p>
  <div className="row g-4 mt-2">
   <div className="col-lg-8"><div className="card border-0 shadow-sm p-4">
    <h3>Dashboard workspace</h3><p>Collaborative learning tools, resources, activity and progress data appear here.</p>
